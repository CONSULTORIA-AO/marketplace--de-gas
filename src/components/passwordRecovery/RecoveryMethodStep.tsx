  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="space-y-3 sm:space-y-4">
        ...
        >
          <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full gradient-[#137fec] flex items-center justify-center flex-shrink-0 bg-[#fff] text-[#137fec]">
            <Mail className="w-5 h-5 sm:w-6 sm:h-6 text-[#137fec]" />
          </div>
        ...
        >
          <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full gradient-[#137fec] flex items-center justify-center flex-shrink-0 bg-[#fff] text-[#137fec]">
            <Smartphone className="w-5 h-5 sm:w-6 sm:h-6 text-[#137fec]" />
          </div>
