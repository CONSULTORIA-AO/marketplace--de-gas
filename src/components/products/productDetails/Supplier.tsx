  ...
  return (
    <div className="lg:col-span-1">
      <div className="bg-white rounded-2xl p-8 border-border-soft sticky top-28 space-y-6 border-border-light dark:border-border-dark border border-slate-100 dark:border-slate-800 shadow-xl">
        <h3 className="text-xl font-extrabold text-text-[#137fec]">
          Sobre o Fornecedor
        </h3>
        <div className="flex items-center gap-4 py-4">
          <div
            className="bg-center bg-no-repeat aspect-square bg-cover rounded-2xl size-20 shadow-md ring-4 ring-background-main"
          ...
          ></div>
          <div>
            <h4 className="font-extrabold text-xl text-text-[#137fec]">
              Gás do Bairro
            </h4>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="p-4 bg-background-main rounded-xl text-center border border-border-soft">
            <div className="flex items-center justify-center gap-1 text-[#137fec] mb-1">
        ...
        <Button className="flex w-full items-center justify-center rounded-xl h-12 px-4 bg-[#137fec]/5 text-[#137fec] font-bold hover:bg-[#137fec]/10 transition-colors border border-[#137fec]/20">
