export function Reviews(){
    return(
        <div 
            className="bg-white p-10 rounded-2xl border-border-soft border-border-light dark:border-border-dark border border-slate-100 dark:border-slate-800 shadow-xl">
