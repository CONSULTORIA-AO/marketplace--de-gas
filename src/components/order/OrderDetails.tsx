        ...
        <div className="bg-surface-light dark:bg-surface-dark rounded-xl border border-border-light dark:border-border-dark shadow-xl border-slate-100 dark:border-slate-800">
          ...
          <div className="p-4">
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-2">
              <Button className="flex-1 flex items-center justify-center gap-2 h-10 px-4 bg-[#137fec]/10 text-[#137fec] rounded-lg text-sm font-bold hover:bg-[#137fec]/20 transition-colors">
                <span>Ajuda com o Pedido</span>
              </Button>
              <Button className="flex-1 flex items-center justify-center gap-2 h-10 px-4 bg-[#137fec] text-white rounded-lg text-sm font-bold shadow-sm hover:bg-[#137fec]/90 transition-colors">
