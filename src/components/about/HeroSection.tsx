  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-glow bg-secondary/50 mb-8 opacity-0 animate-fade-in"
        ...
        <h1
          className="font-display text-5xl md:text-7xl lg:text-8xl font-800 leading-tight mb-6 opacity-0 animate-fade-in-up"
          style={{ animationDelay: '0.4s' }}
        >
          Energia que <span className="text-gradient">move</span>
          <br />o seu negócio
        </h1>
        ...
        >
          <Button
            variant="default"
            size="lg"
            className="text-base font-semibold shadow-[var(--shadow-warm)]"
          >
          ...
          <Button
            variant="outline"
            size="lg"
            className="text-base font-semibold border-glow"
          >
            Encontrar Agência
          </Button>
        </div>
