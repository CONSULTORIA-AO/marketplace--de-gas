...
export function Footer(){
  const links = [
    { id:1,
      lable:"Sobre AngoVerso",
      url: "/sobre"
    }, 
    {
      id:2,
      label:"Como tornar Um vendedor",
      url:"/contacto"
    },
    {
      id:3,
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div className="col-span-1">
              <motion.div whileHover={{ scale: 1.02 }} className="cursor-pointer mb-3">
            ...
            <div>
              ...
              <div>
                <p className="text-white font-bold text-sm mb-3">Baixe o Nosso Aplicativo</p>
                <motion.div
                  whileHover={{ scale: 1.04 }}
                  whileTap={{ scale: 0.97 }}
                  className="inline-flex items-center gap-2 bg-orange-400 text-white px-4 py-2.5 rounded-lg cursor-pointer"
                >
                  <span className="text-xl"><LiaGooglePlay /></span>
                  <div>
              ...
              <div>
                ...
                <div className="flex gap-3 text-blue-500">
                  {[
                    { icon: <FaFacebook style={{color: "#3B82F6"}}/>, label: "WhatsApp" },
                    { icon: <FaInstagram style={{ color: "rgb(221, 42, 123)" }}/>, label: "Facebook" },
                  ].map((s) => (
                    <motion.button
                      key={s.label}
