...
export function Footer() {
  return (
    <footer className="bg-card-light dark:bg-card-dark border-border-light dark:border-border-dark mt-16 border border-orange-300 dark:border-slate-800 border-t border-glow py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-lg font-bold">JáGás</h2>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-orange-500 dark:text-orange-400">
              <li>
              ...
              <li>
                <Link className="hover:text-primary" to="/termos&politicas">
                  Termos de Uso
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <Link className="text-blue-500 hover:text-primary" to="#">
                <svg
                  aria-hidden="true"
                  className="w-6 h-6"
                  fill="currentColor"
              ...
              <Link className="text-orange-500 hover:text-primary" to="#">
                <svg
                  aria-hidden="true"
                  className="w-6 h-6"
                  fill="currentColor"
