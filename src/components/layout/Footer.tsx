...
export function Footer() {
  ...
  return (
    <footer 
      className="bg-card-light dark:bg-card-dark border-t border-border-light dark:border-border-dark mt-16">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Seu marketplace de gás, conectando você aos melhores fornecedores.</p>
          </div>
          <div>
          <h3 className="font-bold mb-4">Institucional</h3>
          <ul className="space-y-2 text-sm text-gray-500 dark:text-gray-400">
            <li><Link className="hover:text-primary" to="#">Sobre Nós</Link></li>
            <li><Link className="hover:text-primary" to="#">Termos de Uso</Link></li>
            <li><Link className="hover:text-primary" to="#">Política de Privacidade</Link></li>
          </ul>
        </div>
        <div>
          <h3 className="font-bold mb-4">Ajuda</h3>
            <ul className="space-y-2 text-sm text-gray-500 dark:text-gray-400">
              ...
              <li><Link className="hover:text-primary" to="#">Contato</Link></li>
              <li><Link className="hover:text-primary" to="#">Seja um Fornecedor</Link></li>
            </ul>
        </div>
        <div>
          <h3 className="font-bold mb-4">Siga-nos</h3>
          <div className="flex space-x-4">
            <Link className="text-gray-500 hover:text-primary" to="#"><svg aria-hidden="true" className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path clip-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" fill-rule="evenodd"></path></svg></Link>
