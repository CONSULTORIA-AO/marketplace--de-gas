  ...
  return (
    <header className="sticky top-0 z-50 bg-white shadow-sm">
      ...
      <div className="w-full px-4 lg:px-8 py-3 flex items-center gap-4">
        ...
        <div
          className="flex-1 flex items-center border border-gray-200 rounded-lg overflow-hidden bg-white shadow-sm"
        ...
        >
          ...
          <button
            ...
            className="px-5 py-2.5 bg-[#FFA500] hover:cursor-pointer text-white text-sm font-semibold hover:bg-[#FFA500] transition-colors flex-shrink-0"
          >
            Procurar
          </button>
        </div>
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          ...
          >
            <span className="text-xs text-gray-600 hover:text-[#FFA500] font-medium">
              Acessar conta
            </span>
          </button>
          <button
