  ...
  return (
    <section id="newsletter" className="mb-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute -bottom-40 -left-40 w-80 h-80 bg-[#FFA500]/5 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: '1s' }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[#FFA500]/5 rounded-full blur-3xl animate-pulse"
        ...
        <div className="bg-white border rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden group">
          ...
          >
            ...
            <div className="space-y-2">
              <label
                htmlFor="email"
                className="block text-[#FFA500] font-medium text-sm"
              >
                Email *
              </label>
            ...
            <Button
              ...
              className={`w-full py-4 hover:bg-orange-500 cursor-pointer rounded-xl cursor-pointer font-semibold text-lg transition-all duration-300 ${
                isSubmitting
