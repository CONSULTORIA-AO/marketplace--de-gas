...
export function HeroSection({
  ...
  return(
        <section className="relative">
            <div className="absolute inset-0 bg-cover bg-center bg-no-repeat" data-alt="Blue flame from a gas stove burner in a dark kitchen.">
                <img src={BackGround} alt="Blue flame from a gas stove burner in a dark kitchen." className="w-full h-full object-cover opacity-60"/>
                  ...
                  <Label className="flex flex-col h-14 w-full">
                     <div className="flex w-full flex-1 items-stretch rounded-xl h-full shadow-lg border border-slate-100 dark:border-slate-800 bg-white">
                      ...
                      <div className="flex items-center justify-center rounded-r-xl border-y border-r border-border-light bg-card-light pr-2 border border-slate-100 dark:border-slate-800">
                        <Button 
                          className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-5 bg-[#137fec] text-white text-sm font-bold leading-normal tracking-[0.015em] hover:bg-[#137fec]/90 ">
