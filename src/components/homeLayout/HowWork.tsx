    ...
    <section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
        <div className="flex flex-col items-center">
          ...
          <h3 className="text-lg font-bold mb-2 text-[#ff8300]">1. Busque</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Informe o produto que você precisa e sua localização.
          </p>
        </div>
        <div className="flex flex-col items-center">
          <div className="flex items-center justify-center w-20 h-20 mb-4 rounded-full bg-pink-200 text-[#ff8300]">
            <span className="material-symbols-outlined text-4xl">
              compare_arrows
            </span>
          </div>
          <h3 className="text-lg font-bold mb-2 text-[#ff8300]">2. Compare</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">
        ...
        <div className="flex flex-col items-center">
          ...
          <h3 className="text-lg font-bold mb-2 text-[#ff8300]">3. Compre</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">
        ...
        <div className="flex flex-col items-center">
          ...
          <h3 className="text-lg font-bold mb-2 text-[#ff8300]">4. Receba</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">
