        ...
        <aside className="lg:col-span-1 mt-12 lg:mt-0">
            <div className="sticky top-8">
                <div className="bg-white p-6 rounded-xl border-border-gray ounded-2xl shadow-xl border border-slate-100 dark:border-slate-800">
                    ...
                    <Button 
                        className="w-full bg-primary text-white font-bold py-4 px-6 rounded-lg hover:bg-[#00427c] active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2 shadow-lg shadow-primary/20">
