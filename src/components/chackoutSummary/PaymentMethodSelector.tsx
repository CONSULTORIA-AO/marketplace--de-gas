...
import { Smartphone, Building2, CreditCard, Banknote, QrCode, Wallet, ChevronRight } from "lucide-react";
...
const PaymentMethodSelector = ({
  ...
  const needsPhone = selected === "multicaixa_express" || selected === "unitel_money";
      ...
      <AnimatePresence mode="wait">
        ...
        {needsBankInfo && (
          ...
          >
            ...
            <div className="space-y-1 text-sm text-muted-foreground">
              <p><span className="font-medium text-foreground">Banco:</span> BAI - Banco Angolano de Investimentos</p>
              <p><span className="font-medium text-foreground">IBAN:</span> AO06 0040 0000 1234 5678 9012 3</p>
              <p><span className="font-medium text-foreground">Titular:</span> GásExpress Angola, Lda</p>
            </div>
        ...
        {selected === "referencia_multicaixa" && (
          <motion.div
            ...
            className="space-y-3 overflow-hidden rounded-lg bg-secondary/50 p-4"
          >
            <p className="text-sm font-medium text-foreground">Referência de pagamento:</p>
            <div className="space-y-1 text-sm text-muted-foreground">
              <p><span className="font-medium text-foreground">Entidade:</span> 00123</p>
              <p><span className="font-medium text-foreground">Referência:</span> 456 789 012</p>
              <p><span className="font-medium text-foreground">Montante:</span> Valor total do pedido</p>
            </div>
            <p className="text-xs text-muted-foreground">
              Dirija-se a qualquer ATM Multicaixa e selecione "Pagamentos por Referência".
            </p>
          </motion.div>
        )}
      </AnimatePresence>
