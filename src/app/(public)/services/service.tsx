...
const services = [
  {
    ...
    description:
      'Gás de cozinha entregue na sua porta com rapidez e segurança.',
  },
  {
    icon: Building2,
  ...
  },
  {
    ...
    description:
      'Abastecimento contínuo para operações industriais de grande porte.',
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    ...
    description:
      'Suporte emergencial disponível 24 horas por dia, 7 dias por semana.',
  },
  {
    icon: MapPin,
    title: 'Rede de Agências',
    description:
      'Mais de 200 agências espalhadas por todo o território nacional.',
  },
];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Do residencial ao industrial, oferecemos a melhor infraestrutura de
            distribuição de gás do mercado.
          </p>
        </div>
