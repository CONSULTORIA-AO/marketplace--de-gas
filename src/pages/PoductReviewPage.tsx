    ...
    <main className="min-h-screen flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row-reverse gap-3">
          <Button type="submit" disabled={isSubmitting} className='bg-yellow-500 text-white hover:bg-yellow-600'>
            {isSubmitting ? 'Enviando...' : 'Enviar Avaliação'}
          </Button>

          <Button type="button" className='bg-blue-600 text-white hover:bg-blue-500'>
            Agora não
          </Button>
        </div>
      </motion.form>
