      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        >
          <div className="absolute inset-0 flex flex-col justify-center px-20">
            ...
            <p className="text-white/95 text-xl max-w-md leading-relaxed">
              O marketplace mais completo para compra de gás residencial e
              comercial. Rápido, seguro e transparente.
            </p>

            <div className="mt-12 flex gap-4">
              <div className="flex items-center gap-3 bg-white/20 backdrop-blur-lg rounded-xl p-4 border border-white/30 shadow-lg">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-background-light">
          <div className="w-full max-w-[480px] space-y-8 bg-white p-10 rounded-2xl shadow-xl border border-slate-100 dark:border-slate-800">
            <div className="text-center lg:text-left">
              <h2 className="text-slate-900 dark:text-white text-3xl font-bold tracking-tight mb-2">
                Bem-vindo de volta!
              </h2>
              <p className="text-slate-500 dark:text-slate-400 text-base">
                Acesse sua conta para pedir seu gás de forma rápida.
              </p>
            </div>
